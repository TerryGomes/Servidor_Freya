...
INSERT INTO `bbs_news` VALUES ('1', '0', 'Тестовая новость проекта', 'Test news project', 'Полный текст, тестовой новости.', 'Full text, test news.', 'Сервер: x3', 'Server: x3', 'JF', '11.11.14');
INSERT INTO `bbs_news` VALUES ('2', '1', 'Тестовая новость сервера', 'Test news server', 'Полный текст, тестовой новости.', 'Full text, test news.', 'Сервер: x3', 'Server: x3', 'JF', '11.11.14');